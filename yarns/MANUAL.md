...
- `▽O (OSCILLATOR MENU)`: [audio mode](#oscillator-audio-mode) and [timbre](#oscillator-timbre-settings) for the voice oscillator
...
- `ARPEGGIATOR`: output is generated by the [arpeggiator](#arpeggiator)
  - Rhythm is controlled by the [arpeggiator pattern setting](#arpeggiator-rhythm-control)
...
- `*2` 3-part layout: 4-voice paraphonic part + monophonic part with aux CV + monophonic part without aux CV
  ...
  - [Oscillator mode](#oscillator-mode) cannot be turned off for the paraphonic part
  - Output channels:
