...
static const char* kName[] = {
  ...
  "TRI_THRU_TRI","SINE_THRU_TRI","EXP_THRU_TRI",
  "TRI_THRU_TRI_B","SINE_THRU_TRI_B","EXP_THRU_TRI_B",
  "TRI_THRU_SINE","SINE_THRU_SINE","EXP_THRU_SINE",
  "TRI_THRU_SINE_B","SINE_THRU_SINE_B","EXP_THRU_SINE_B",
  "TRI_THRU_EXP","SINE_THRU_EXP","EXP_THRU_EXP",
  "TRI_THRU_EXP_B","SINE_THRU_EXP_B","EXP_THRU_EXP_B","FM"
};
