...
# do not publish it over chiff_sim.html. NOT COMMITTED: it is a 71 kB page with
# an engine inlined, regenerated by this script when the experiment is revisited.
set -e
cd "$(dirname "$0")"
ROOT=$(cd ../.. && pwd)
